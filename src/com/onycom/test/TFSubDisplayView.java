...
public class TFSubDisplayView extends JPanel implements Runnable {
	...
	public TFSubDisplayView(final int nHpNo) {
		// TODO Auto-generated constructor stub
		setLayout( new BorderLayout() );
		setBackground(Color.black);
		
		imageView = new TFMirroringImageView(nHpNo, true, 1080, 2340);
